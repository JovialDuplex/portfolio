...
export default function NavBarAdmin(){
    ...
    return (
        <>
            ...
            <nav className="py-4 px-2 w-full h-full flex flex-col gap-10">
                <header className="flex gap-4 justify-center items-center"> 
                    <img src={"/logo.png"} alt={"logo"} className="rounded-full h-20 w-20"/>
                </header>

                <ul className="nav text-center pt-4 flex-1 flex flex-col gap-10 font-semibold">
                ...
                <footer className="py-4 border-t-2 border-t-(--border-navbar) flex justify-between items-center gap-3">
